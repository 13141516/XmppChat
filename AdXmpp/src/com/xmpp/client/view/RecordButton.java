...
public class RecordButton extends Button {
	...
	private final String SAVE_PATH = InfoConfig.SAVE_SOUND_PATH;
	...
	private void initDialogAndStartRecord() {
		...
		recordIndicator.addContentView(duraView,
				new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT));
	...
	private void startRecording() {
		// save path
		StringBuilder path = new StringBuilder(SAVE_PATH).append("/tmp_sound_").append(System.currentTimeMillis())
				.append(".amr");
